...
t-pick  = lam(a, b, l): t-app(t-name(module-uri("builtin://pick"), A.s-type-global("Pick"), l, false), [list: a, b], l, false) end
t-iter  = lam(e, l): t-app(t-name(module-uri("builtin://iter"), A.s-type-global("Iter"), l, false), [list: e], l, false) end
